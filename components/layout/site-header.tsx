    ...
    <header className="sticky top-0 z-40 border-b border-ink/8 bg-paper/85 backdrop-blur-xl">
      <div className="shell flex items-center justify-between gap-4 py-4">
        <Link className="group flex items-center gap-3" href="/">
          <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-ink text-lg text-white shadow-lg shadow-ink/10 transition group-hover:-translate-y-0.5">
            ¥
          </span>
          <div>
